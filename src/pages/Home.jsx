...
export default function Home() {
  ...
  return (
    ...
    >
      <h2 style={{ fontSize: 'clamp(26px, 2.4vw, 38px)' }}>우리 생활에 도움을 주는 장소</h2>
      <p style={{ maxWidth: 'clamp(480px, 42vw, 680px)', lineHeight: 1.6, fontSize: 'clamp(15px, 1.1vw, 19px)' }}>
        먼저 충남 지도에서 우리 시군을 찾아보고, 그 안의 우체국, 소방서, 경찰서,
        병원, 행정복지센터, 보건소, 학교, 도서관, 체육관, 기차역, 버스터미널,
        공연장, 공원을 하나씩 눌러보며 어떤 도움을 주는 곳인지 알아보아요!
      </p>
